...
## Hypothesis 1
I test the hypotheses formulated in [Section 1](#expectations) applying a multiverse approach [@steegen2016increasing;@simonsohn2019specification] using the `specr` R package [@masur2020specr].
Instead of running various models using the different dependent variables
