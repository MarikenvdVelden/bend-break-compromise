...
df <- d %>% select(a = gender, b = PreT5, compromise, 
                   PT1:PT4, F2, F4, F7, F8, F9, PreT1:PreT4, 
                   PreT6:PreT8, issue) 
...
p1e <- e1 %>%
  ...
  theme_minimal() +
  labs(x = "Attitudes towards Women in Politics\n Negative (1) - Positive (5)", 
...
df <- d %>% select(a = immigration,  b = PreT5, compromise, 
                   PT1:PT4, F2, F4, F7, F8, F9, PreT1:PreT4, 
                   PreT6:PreT8, issue) 
...
df <- d %>% select(a = intersection, b = PreT5, compromise, 
                   PT1:PT4, F2, F4, F7, F8, F9, PreT1:PreT4, 
                   PreT6:PreT8, issue)  
