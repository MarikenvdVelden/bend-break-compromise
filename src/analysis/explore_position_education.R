regression_explore <- function(df, a, b, compromise, issue){
  ...
  indepVarList <- df %>% select(a, b, compromise, F2, F4, F7, F8, F9, 
                                PreT1, PreT2, PreT3, PreT5:PreT8, issue)   
...
df <- d %>% select(a = gender, b = PreT4, compromise, 
                   PT1:PT4, F2, F4, F7, F8,  F9, PreT1, PreT2, PreT3, PreT5:PreT8, issue) 
...
df <- d %>% select(a = immigration, b = PreT4, compromise, 
                   PT1:PT4, F2, F4, F7, F8, F9, PreT1, PreT2, PreT3, PreT5:PreT8, issue)  
...
df <- d %>% select(a = intersection, b = PreT4, compromise, 
                   PT1:PT4, F2, F4, F7, F8, F9, PreT1, PreT2, PreT3, PreT5:PreT8, issue) 
