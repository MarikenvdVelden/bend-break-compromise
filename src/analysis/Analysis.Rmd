...
```{r "visualize-unbalanced-vars", fig.height=10, fig.width=10}
...
```{r "save-patchwork-results", echo = F, fig.show="hide", fig.height= 15, fig.width=15}
h1 + h2 + h3 + h3p + plot_layout(ncol=2)
```
