...
## Descriptive Results
```{r "descriptive-results", echo=FALSE, fig.height=10, fig.width=8}
d %>%
...
```{r "balance-checks", fig.height=8, fig.width=8}
...
```{r "h3-pooled", fig.align="center", fig.height=5, fig.width=5}
