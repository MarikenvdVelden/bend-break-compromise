...
df <- d %>% select(a = gender, b = PreT3, compromise, 
                   PT1:PT4, F2, F4, F7, F8, F9, PreT1, PreT2, PreT4:PreT8, issue) 
...
df <- d %>% select(a = immigration, b = PreT3, compromise, 
                   PT1:PT4, F2, F4, F7, F8, F9, PreT1, PreT2, PreT4:PreT8, issue)  
...
df <- d %>% select(a = intersection, b = PreT3, compromise, 
                   PT1:PT4, F2, F4, F7, F8, F9, PreT1, PreT2, PreT4:PreT8, issue) 
